...
#     path_test = '/shenlab/lab_stor5/dongnie/pelvic'
    ...
    path_patients_h5 = '/shenlab/lab_stor5/dongnie/pelvic/pelvicSegRegContourBatchH5'
...
#     path_patients_h5 = '/home/dongnie/warehouse/pelvicSeg/pelvicSegRegPartH5/' #only contains 1-15
    ...
    path_patients_h5_test = '/shenlab/lab_stor5/dongnie/pelvic/pelvicSegRegContourH5Test'
...
#             ct_estimated = testOneSubject(mrnp,ctnp,[3,168,112],[1,168,112],[1,8,8],netG,'Segmentor_model_%d.pt'%iter)
            ...
            matFA = mrnp
            matGT = ctnp
            matOut,_ = testOneSubject(matFA,matGT,4,[3,168,112],[1,168,112],[1,8,8],netG,opt.prefixModelName+'%d.pt'%iter)
