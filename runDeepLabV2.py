...
parser.add_argument("--zoomRate", type=float, default=9/64.0, help="Sample importance from AD network. Default=1")
...
parser.add_argument("--resume", default="/shenlab/lab_stor5/dongnie/pelvic/Segmentor_deeplabv2_0117_10000.pt", type=str, help="Path to checkpoint (default: none)")
parser.add_argument("--start_epoch", default=1, type=int, help="Manual epoch number (useful on restarts)")
parser.add_argument("--threads", type=int, default=1, help="Number of threads for data loader to use, Default: 1")
parser.add_argument("--momentum", default=0.9, type=float, help="Momentum, Default: 0.9")
parser.add_argument("--weight-decay", "--wd", default=1e-4, type=float, help="weight decay, Default: 1e-4")
parser.add_argument("--pretrained", default="", type=str, help="path to pretrained model (default: none)")
parser.add_argument("--prefixModelName", default="/shenlab/lab_stor5/dongnie/pelvic/Segmentor_deeplabv2_0117_", type=str, help="prefix of the to-be-saved model name")
parser.add_argument("--prefixPredictedFN", default="preSub_deeplabv2_0117_", type=str, help="prefix of the to-be-saved predicted filename")
...
#             ct_estimated = testOneSubject(mrnp,ctnp,[3,168,112],[1,168,112],[1,8,8],netG,'Segmentor_model_%d.pt'%iter)
            ...
            matOut,_ = testOneSubject(matFA,matGT,4,[3,64,64],[1,9, 9],[1,9,9],netG,opt.prefixModelName+'%d.pt'%iter)
