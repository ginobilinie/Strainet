...
from blocks import RefineNetBlock, ResidualConvUnit, RefineNetBlockImprovedPooling
...
class BaseRefineNet4Cascade(nn.Module):
    ...
    def __init__(self, input_shape,
        ...
        if input_size % 32 != 0:
            raise ValueError("{input_shape} not divisble by 32")
        ...
        self.layer4_rn = nn.Conv2d(
            2048, 1 * features, kernel_size=3, stride=1, padding=1, bias=False)

        self.refinenet4 = RefineNetBlock(
            1 * features, (1 * features, input_size // 32))
#         print 'inputsize//32: ',input_size//32
        self.refinenet3 = RefineNetBlock(
            features, (1 * features, input_size // 32), (features, input_size // 16))
...
#         print 'layer_4_rn: ',layer_4_rn.size()
        path_4 = self.refinenet4(layer_4_rn)
#         print 'layer_4',layer_4.size() ,'layer_4_rn: ',layer_4_rn.size() ,'path_4 size: ',path_4.size(),' layer_3_rn size: ',layer_3_rn.size()
